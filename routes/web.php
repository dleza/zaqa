...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(EnsureAccountIsActive::class)->prefix('applicant')->name('applicant.')->group(function () {
        ...
        Route::post('/applications/{application}/payment/card/capture-context', [ApplicantPaymentController::class, 'createCardCaptureContext'])->name('applications.payment.card.capture_context');
        ...
        Route::post('/payments/{payment}/card/confirm', [ApplicantPaymentController::class, 'confirmCardPayment'])->name('payments.card.confirm');
