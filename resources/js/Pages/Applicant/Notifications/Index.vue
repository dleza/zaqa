...
function markAllRead() {
  router.post('/applicant/notifications/read-all', {}, { preserveScroll: true })
}

function markRead(id: string) {
  router.post(`/applicant/notifications/${id}/read`, {}, { preserveScroll: true })
}
</script>

<template>
  <ApplicantLayout containerMaxWidthClass="max-w-5xl">
    <div class="space-y-6">
      <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-text-muted">Updates and actions related to your applications.</p>
        </div>
            ...
            <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <div class="flex shrink-0 flex-wrap items-center gap-2">
                <Link
                  ...
                  :href="`/applicant/notifications/${n.id}/open`"
                  method="post"
                  as="button"
                >
                  Open
