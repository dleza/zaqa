...
watch([q, overdue, overdueDays, submittedFrom, submittedTo, qualificationQ, foreign, sort, direction, listBasePath], () => {
  router.get(
    listBasePath.value,
    {
      q: q.value || null,
      ...
      <div class="border-b border-border bg-surface-muted px-5 py-4">
        <div class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4">
          <div class="relative xl:col-span-1">
            ...
            <Search class="pointer-events-none absolute left-3 top-[2.05rem] h-4 w-4 -translate-y-1/2 text-text-muted" aria-hidden="true" />
            <input v-model="q" class="zaqa-input h-10 w-full pl-9" placeholder="Application #, holder, reference…" />
          </div>
          <div>
            <label class="mb-1 block text-xs font-semibold text-text-muted">Qualification title</label>
            <input v-model="qualificationQ" type="text" class="zaqa-input h-10 w-full" placeholder="Contains…" />
          </div>
          <div>
