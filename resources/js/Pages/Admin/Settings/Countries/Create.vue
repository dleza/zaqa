...
function submit() {
  form.post('/admin/settings/countries', { preserveScroll: true })
}
</script>
      ...
      <template #header>
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 class="mt-2 text-2xl font-semibold tracking-tight text-text-primary">Add country</h1>
            <p class="mt-1 text-sm text-text-muted">Create a new country record.</p>
          </div>
