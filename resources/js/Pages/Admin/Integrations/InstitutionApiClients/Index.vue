      ...
      <div class="rounded-2xl border border-border bg-surface p-5 shadow-sm">
        <div class="flex flex-col gap-4">
          <div>
            ...
            <div class="mt-1 text-xs text-text-muted">Search clients by name, institution, or active state.</div>
          </div>

          <div class="grid gap-3 lg:grid-cols-[minmax(0,1.6fr)_minmax(220px,1fr)_minmax(180px,0.8fr)_auto] lg:items-end">
            <div>
      ...
      <div class="overflow-hidden rounded-2xl border border-border bg-surface shadow-sm">
        ...
        <div v-if="clients.data.length === 0" class="px-5 py-6">
          <div class="rounded-2xl border border-dashed border-border bg-surface-muted p-8 text-center">
            ...
            <div class="mt-4 text-sm font-semibold text-text-primary">No API clients yet</div>
